...
namespace MatrixLib.Tests
{
    public class MatrixTests
    {
        ...
        [Fact]
        public void Multiply_IncompatibleMatrices_Throws_WithMessage()
        {
            Matrix a = new(2, 3);
            Matrix b = new(2, 2);
            var ex = Assert.Throws<ArgumentException>(() => a.Multiply(b));
        ...
        [Fact]
        public void Constructor_ZeroByZero_CreatesEmptyMatrix()
        {
        ...
        public static IEnumerable<object[]> MultiplyByIdentityData()
        {
            ...
            yield return new object[] { new Matrix(new double[,] { { 1, 2, 3 } }) };
            yield return new object[] { new Matrix(new double[,] { { 1 }, { 2 }, { 3 } }) };
        }
        ...
        [Benchmark]
        public void Multiply_LargeMatrices_Performance()
        {
            int n = 200;
    ...
    public class MatrixBenchmarks
    {
        ...
        {
            var test = new MatrixTests();
            test.Multiply_LargeMatrices_Performance();
        }
